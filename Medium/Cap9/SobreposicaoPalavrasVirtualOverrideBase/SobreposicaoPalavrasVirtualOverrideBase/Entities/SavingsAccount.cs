...
using SobreposicaoPalavrasVirtualOverrideBase.Entities; // Importa a classe base Account, que está no mesmo namespace

namespace SobreposicaoPalavrasVirtualOverrideBase.Entities
{
    internal class SavingsAccount : Account // Classe SaveAccount herda de Account (relacionamento "é um")
    {
        ...
        public override void WithDraw(double amount) // Sobrescreve o método WithDraw da classe base
        {
